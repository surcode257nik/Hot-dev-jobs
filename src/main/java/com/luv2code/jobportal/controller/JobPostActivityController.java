...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        model.addAttribute("partTme", Objects.equals(partTime,"Part-Time"));
        ...
        System.out.println("password"+authentication.getCredentials()+"name:"+authentication.getName());
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
                ...
                List<JobSeekerApply> jobSeekerApplyList =
                        jobSeekerApplyService.getCandidatejobs((JobSeekerProfile) currentUserProfile);
                List<JobSeekerSave>  jobSeekerSaveList=
                jobSeekerSaveService.getCandidatesByJob((JobSeekerProfile) currentUserProfile);
